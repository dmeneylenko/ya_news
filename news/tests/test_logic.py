...
class TestCommentEditDelete(TestCase):
    # Тексты для комментариев не нужно
    # дополнительно создавать
    # (в отличие от объектов в БД), им не
    #  нужны ссылки на self или cls,
    ...
    def setUpTestData(cls):
        ...
        news_url = reverse('news:detail', args=(cls.news.id,))  # Адрес
        # новости.
        cls.url_to_comments = news_url + '#comments'  # Адрес
        # блока с комментариями.
